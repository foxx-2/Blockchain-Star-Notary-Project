...
contract StarNotary is ERC721 {
    ...
    string public name = "CheckmateToken";// name: Is a short name to your token
    string public symbol= "CKMT";// symbol: Is a short string like 'USD' -> 'American Dollar'
   ...
   // constructor(string name, string symbol) ERC721Full (name, symbol) public {}
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require((ownerOf(_tokenId) == msg.sender , "Only owner of star can exchange Stars"));
